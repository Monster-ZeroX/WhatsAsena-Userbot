...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/kaviya-admin/WhatsAsena-Userbot)

### The Hard Method
```js
$ git clone https://github.com/kaviya-admin/WhatsAsena-Userbot.git
$ cd WhatsAsena-Userbot
$ npm i
$ nano Config.env
